...
# Methods
Data was collected from participants with and without frequent nightmares. Participants were exposed to neutral and negative IAPS pictures in three blocks, while skin conductance and electrocardiogram was recorded. Participants had to evaluate arousal and valence of each picture after exposure. Subsequently, participant spent a night at the sleep lab, and participated in a recall session where the original pictures and new pictures were shown.

# Data analysis strategy
- We use linear mixed-effects modeling using the lme4 package
- The random stucture is determined by the Zuur (2009) method to determine the random and fixed structure
...
Participants had to rate each picture on an arousal/valence scale. These values were aggregated by picture type and block.
...
There is a clear and strong effect of the picture type as negative pictures are associated with a higher subjective arousal. There is a weak block effect, that shows that arousal evaluations are slightly decreasing over time.
...
- SCR decreased in each subsequet block, showing signs of habituation
...
Finding: Ther was no evidence for a difference in SCR before and after sleep.
